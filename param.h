...
# else
      parameter (LLm0=1203,  MMm0=1203,   N=50)   ! YOUR REGIONAL CONFIG
# endif
#elif defined COASTAL 
# if defined VILAINE
      parameter (LLm0=180,  MMm0=130,  N=10)   ! VILAINE
# else
      parameter (LLm0=199,   MMm0=208,   N=50)   ! YOUR COASTAL CONFIG
# endif
#else
...
!
      ...
      parameter (NP_XI=24,  NP_ETA=32,  NNODES=NP_XI*NP_ETA)
      parameter (NPP=1)
